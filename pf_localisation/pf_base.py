...
class PFLocaliserBase(object):
    ...
    def __init__(self):
        # super().__init__('PFLocaliserBase')
        self.logger = rcutils_logger.RcutilsLogger('PFLocaliserBase')
        # ----- Initialise fields
        ...
        # ----- Sensor model
        self.sensor_model =  pf_localisation.sensor_model.SensorModel()
    ...
    def recalculate_transform(self, currentTime):
        ...
        :Args:
            | currentTime (rclpy.time.Time): Time stamp for this update
         """

        transform = Transform()

        T_est = tf_transformations.quaternion_matrix([self.estimatedpose.pose.pose.orientation.x,
        ...
        T_odom = tf_transformations.quaternion_matrix([self.last_odom_pose.pose.pose.orientation.x,
        ...
        q = tf_transformations.quaternion_from_matrix(T) #[:3, :3])
